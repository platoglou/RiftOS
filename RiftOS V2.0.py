...
def ccboot():
        ...
        if os_choice == '1':
            ...
            print('Exiting CC BootTool...')
            time.sleep(1)
            os.system('cls')
            exit()

        elif os_choice == '3':
            print('Booting To PreRelease Version...')
            time.sleep(1)
            os.system('cls')
            PreReleases()
            ...
            print('Booting To Advanced Menu...')
            time.sleep(1)
            os.system('cls')
            ct()
